...
@section('content')
    ...
    <div class="page-wrapper">
        ...
        <div class="content container-fluid">
            ...
            <div class="row pt-3">
                <div class="col-md-12">
                    <h4 style="color: dimgray"><i class="fa fa-list-alt"><strong> Category List</strong></i></h4>
                    <div class="table-responsive">
                        <table class="table table-striped custom-table datatable table-border" id="DataTable">
                            ...
                            @foreach ($categories as $key=>$categorie)
                                <tr>
                                    <td>{{$key+1}}</td>
                                    <td hidden class="ids">{{ $categorie->id }}</td>
                                    <td class="name"><strong>{{$categorie->name}}</strong></td>
                                    <td class="text-center">
                                        <a class="Update" data-toggle="modal" data-id="'.$categorie->id.'" data-target="#edit" style="color: #bdad11;cursor: pointer"><button class="btn btn-warning btn-sm">Edit</button></a>
                                    </td>
                                </tr>
                            @endforeach
